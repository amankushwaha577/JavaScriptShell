...
delete Operator :
-----------------
1. The delete operator removes a property from an object, but it doesn't delete variables. */
...
/*
2. delete on array elements leaves holes; use splice to avoid this. */
...
---------------------------------------------------
3. Variables declared in these ways cannot be deleted using the delete operator: */
