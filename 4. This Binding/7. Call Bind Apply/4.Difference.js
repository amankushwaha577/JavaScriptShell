...
//        ---------------------------------------------------------------------------------------------------------------
//        Use Case                   | When you know and pass arguments one by one. | When arguments are in an array.          | When you need a pre-set function for future use.
//        ---------------------------------------------------------------------------------------------------------------
//
//        Examples:
//        ==========================================================================================
...
//        ==========================================================================================
//        **Quick Tips**:
//        - `call` is for immediate execution with individual arguments.
//        - `apply` is for immediate execution with arguments in an array.
//        - `bind` is for creating a new function that can be executed later with a fixed `this`.
//        ==========================================================================================
//